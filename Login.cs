...
namespace MultiUserAtm
{
    ...
    {
        public string uname, bal, mailbal;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
                ...
                con.Open();
                cmd = new SqlCommand("select * from multitb  where NAme='" + label3.Text + "' and Accno='" + uname + "' ", con);
                SqlDataReader dr = cmd.ExecuteReader();
                if (dr.Read())
                {

                    if (dr["UserType"].ToString() == "AccountHolder")
                    {
                        ...
                        cmd = new SqlCommand("insert into transactiontb values('" + uname + "','" + DateTime.Now.ToShortDateString() + "','" + DateTime.Now.ToShortTimeString() + "','Success' )", con);
                        // con.Open();
                        cmd.ExecuteNonQuery();
                        //  con.Close();
                    ...
                    else
                    {
                        ...
                        UserHome1 uu = new UserHome1();
                        uu.accno = dr["Accno"].ToString();
                        uu.bal = bal;
                        uu.umob = dr["Mobile"].ToString();
                        uu.umail = dr["Email"].ToString();
                        uu.uname = label3.Text;
                ...
                {
                    dr.Close();
                    cmd = new SqlCommand("insert into transactiontb values('" + uname + "','" + DateTime.Now.ToShortDateString() + "','" + DateTime.Now.ToShortTimeString() + "','Failed') ", con);
                    //  con.Open();
                    cmd.ExecuteNonQuery();
                    // con.Close();
